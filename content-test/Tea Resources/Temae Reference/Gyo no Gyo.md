...
> [!Tip] Furo vs Ro  
> Differences between this and the [[Gyo no Gyo (Furo)|furo]] version will be **bolded**. If there's a difference between the two that isn't bolded, it might be a mistake.
...
- From this position, **move the shakutate laterally to center.**
    - Both hands down (it contains hibashi after all).
    - R only moves shakutate to center.
    - [?] TODO I have in my notes from [[Okeiko-Glenn-2021-12-12]] that you sit right back up here. No returning down again. Really? ➕ 2025-11-01
...
- Place the fukusa as-is on the floor, karioki by the right knee, then open the hoya-san **from its place already on tatami**.
    - NOTE: [[Fukusa karioki position in ro|You cannot place the fukusa beyond the halfway point of the ro]].
...
- Warm the chawan, purify the dai, and do chasentoshi as usual for [[Daitenmoku]] temae. Chawan goes to ji-ita when warming.
    ...
    - **Turn back to imai, close kama lid with fukusa, close hoyasan, then continue.**
    ...
    - **Place the chasen to the right of the ro on completion, ie the same position as in [[Shikaden]].**
...
- Take the chashaku (1h from top-bottom), and place it on the right side of the *hane*.
...
- Return the chashaku to its home, then open the mizusashi with the lid in the *gyo* position.
...
- Scoot back forward and answer questions from kyakutsuki.
    ...
    - Gyo-no-gyo has [[Number of sweets for higher temae|five sweets]].
...
- Return to imai, and finish putting away the daisu.
    - Turn back to imai
...
- Exit with kensui.
    - *Shittai* from imai, then pick up the kensui while low and exit.
- Return, exit with bon and chawan.
    - Return to temaeza sitting low, then *shikko*.
...
- Bring a [[Rikyugata Chuu Natsume]] back in on return.
    ...
    - When placing on the ten-ita, hold the natsume more from the side, being careful not to touch the ten-ita with your arm.
        - If you are short, you can [[Sitting up to reach the daisu ten-ita|kneel forward]] to reach.
- *Answer questions*
- To exit:
